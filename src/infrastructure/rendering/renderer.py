...
class CalendarRenderer:
    ...
    def __init__(self, base_dir: Path) -> None:
        ...
        self.template_path = paths.template("calendar")
        self.css_path = paths.style("calendar")
        self.images_dir = paths.images_dir()
        self.font_path = paths.font("ADLaMDisplay-Regular.ttf")
    ...
    def _get_font_for_embedding(self) -> Path | None:
        ...
        if self.font_path.exists():
            ...
            logger.warning(
                ...
                f"{MAX_FONT_SIZE / 1024 / 1024:.2f}MB)，跳过嵌入"
            )
        return None
    ...
    def _inline_fonts_in_css(self, css: str) -> str:
        ...
        # 检查字体大小限制
        if self.font_path.stat().st_size >= MAX_FONT_SIZE:
    ...
    async def render(
        ...
        payload_dict = {
            ...
            "year": payload.year,
            "month": payload.month,
            "is_current_month": payload.is_current_month,
